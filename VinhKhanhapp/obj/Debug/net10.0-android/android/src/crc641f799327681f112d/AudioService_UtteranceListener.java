...
public class AudioService_UtteranceListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("VinhKhanhapp.Services.AudioService+UtteranceListener, VinhKhanhapp", AudioService_UtteranceListener.class, __md_methods);
	}

	public AudioService_UtteranceListener ()
	{
		super ();
		if (getClass () == AudioService_UtteranceListener.class) {
			mono.android.TypeManager.Activate ("VinhKhanhapp.Services.AudioService+UtteranceListener, VinhKhanhapp", "", this, new java.lang.Object[] {  });
		}
	}
